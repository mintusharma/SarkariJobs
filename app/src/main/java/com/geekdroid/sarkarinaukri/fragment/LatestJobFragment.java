...
public class LatestJobFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_latest_job, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        recyclerView = view.findViewById(R.id.latestFragmentRV);
        recyclerView.setLayoutManager(new LinearLayoutManager(mContext));
        recyclerView.setHasFixedSize(true);
        progressBar = view.findViewById(R.id.progressBarLatest);
        new LoadData().doInBackground();
            ...
            try {
                ...
                StringRequest mRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        myAdapter = new MoreListDetailsAdapter(mContext, list, "Apply now", "",R.drawable.ic_work);
