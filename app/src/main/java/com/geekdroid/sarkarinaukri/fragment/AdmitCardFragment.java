...
public class AdmitCardFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_admit_card, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Download Admit Card");
        mContext=view.getContext();

        recyclerView = view.findViewById(R.id.admitCardFragmentRV);
        ...
        progressBar = view.findViewById(R.id.progressBarAdmit);
    ...
    public class LoadData extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            requestQueue = MySingleton.getInstance(mContext).getRequestQueue();
            try {
                final String url = getResources().getString(R.string.links).concat("/admitcard.php");
                StringRequest mRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        myAdapter = new MoreListDetailsAdapter(mContext, list,"Check now","",R.drawable.ic_newadmitcard);
                        recyclerView.setAdapter(myAdapter);
