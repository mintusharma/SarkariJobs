...
public class AdmitCardActivity extends AppCompatActivity implements SearchView.OnQueryTextListener{
            ...
            try {
                ...
                StringRequest mRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        myAdapter = new MoreListDetailsAdapter(getApplicationContext(), list,"Check now","",R.drawable.ic_newadmitcard);
